...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/dashboard/subsites': { section: 'console', module: 'subsites' },
  '/dashboard/site-models': { section: 'admin', module: 'dashboard' },
  '/dashboard/users': { section: 'admin', module: 'dashboard' },
  '/keys': { section: 'console', module: 'token' },
  '/usage-logs': { section: 'console', module: 'log' },
  '/usage-logs/common': { section: 'console', module: 'log' },
  '/quota-requests': { section: 'console', module: 'quota_requests' },
  '/usage-logs/drawing': { section: 'console', module: 'midjourney' },
  '/usage-logs/task': { section: 'console', module: 'task' },
  '/mcp/market': { section: 'console', module: 'mcp_market' },
  '/wallet': { section: 'personal', module: 'topup' },
  '/profile': { section: 'personal', module: 'personal' },
  '/mcp/bridge-clients': { section: 'tunnel', module: 'devices' },
  '/mcp/my-tunnel-apps': { section: 'tunnel', module: 'apps' },
  '/mcp/tunnel-connections': { section: 'tunnel', module: 'connections' },
  '/mcp/tunnel-sessions': { section: 'tunnel', module: 'sessions' },
  '/channels': { section: 'admin', module: 'channel' },
  '/models': { section: 'admin', module: 'models' },
  '/models/metadata': { section: 'admin', module: 'models' },
  '/models/deployments': { section: 'admin', module: 'models' },
  '/users': { section: 'admin', module: 'user' },
  '/enterprise': { section: 'admin', module: 'enterprise' },
  '/training-data': { section: 'admin', module: 'training_data' },
  '/mcp': { section: 'admin', module: 'mcp' },
  '/mcp/tools': { section: 'admin', module: 'mcp' },
  '/mcp/tunnel-apps': { section: 'admin', module: 'mcp' },
  '/mcp/tool-calls': { section: 'admin', module: 'mcp' },
  '/mcp/billing-events': { section: 'admin', module: 'mcp' },
  '/mcp/audit-logs': { section: 'admin', module: 'mcp' },
  '/redemption-codes': { section: 'admin', module: 'redemption' },
  '/package-skus': { section: 'admin', module: 'package_skus' },
