    ...
    build: (settings: AuthSettings) => (
      <OAuthSection
        defaultValues={{
          ...
          HStationOAuthEnabled: settings.HStationOAuthEnabled,
          HStationClientId: settings.HStationClientId,
          HStationClientSecret: settings.HStationClientSecret,
          HStationAuthorizationEndpoint: settings.HStationAuthorizationEndpoint,
          HStationTokenEndpoint: settings.HStationTokenEndpoint,
          HStationUserInfoEndpoint: settings.HStationUserInfoEndpoint,
          HStationScopes: settings.HStationScopes,
