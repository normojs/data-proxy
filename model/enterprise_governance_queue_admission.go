...
type EnterpriseGovernanceQueueAdmission struct {
	...
	LastReplayStatusCode int    `json:"last_replay_status_code" gorm:"not null;default:0"`
	LastReplayDurationMs int64  `json:"last_replay_duration_ms" gorm:"not null;default:0"`
	LastFailureStage     string `json:"last_failure_stage" gorm:"type:varchar(64);not null;default:''"`
	LastReplayRequestId  string `json:"last_replay_request_id" gorm:"type:varchar(128);not null;default:''"`
