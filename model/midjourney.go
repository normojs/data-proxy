...
type Midjourney struct {
	...
	RequestId      string `json:"-" gorm:"type:varchar(128);default:'';index"`
	TokenId        int    `json:"-" gorm:"index"`
	Group          string `json:"-" gorm:"type:varchar(64);default:'';index"`
	BillingSource  string `json:"-" gorm:"type:varchar(64);default:'';index"`
