...
- ~~`mcp_code` 路径：生产 tools/list + tools/call 端到端仍待补~~ → **2026-07-19 PASS**，见 `docs/p2-mcp-code-e2e-evidence-2026-07-19.md`（`sha-5f695ffe`，app id=2 / slug `tun-bqzyhbyt2mmx`）；单元覆盖仍有 `go test ./service -run TunnelMCP`
