...
```bash
go run ./cmd/dpa enroll --server https://dp.app.mbu.ltd --setup-token <one-time-token>
go run ./cmd/dpa enroll --server https://dp.app.mbu.ltd --access-token <dashboard-access-token> --user-id <id>
