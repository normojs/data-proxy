...
func (a *Adaptor) ConvertGeminiRequest(*gin.Context, *relaycommon.RelayInfo, *dto.GeminiChatRequest) (any, error) {
	return nil, channel.NewUnsupportedFeatureError("zhipu_4v", "ConvertGeminiRequest")
}
...
func (a *Adaptor) ConvertAudioRequest(c *gin.Context, info *relaycommon.RelayInfo, request dto.AudioRequest) (io.Reader, error) {
	return nil, channel.NewUnsupportedFeatureError("zhipu_4v", "ConvertAudioRequest")
}
...
func (a *Adaptor) ConvertRerankRequest(c *gin.Context, relayMode int, request dto.RerankRequest) (any, error) {
	return nil, channel.NewUnsupportedFeatureError("zhipu_4v", "ConvertRerankRequest")
}
...
func (a *Adaptor) ConvertOpenAIResponsesRequest(c *gin.Context, info *relaycommon.RelayInfo, request dto.OpenAIResponsesRequest) (any, error) {
	return nil, channel.NewUnsupportedFeatureError("zhipu_4v", "ConvertOpenAIResponsesRequest")
}
